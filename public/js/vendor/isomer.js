...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Has this point and pointToCompare at the same coordinates
	 */
	 Point.prototype.equals = function(pointToCompare) {
	 	return this.x == pointToCompare.x && this.y == pointToCompare.y && this.z == pointToCompare.z;
	 }
...
/***/ function(module, exports, __webpack_require__) {
	...
	Canvas.prototype.path = function(points, color) {
	  ...
	  this.ctx.globalAlpha = (color) ? color.a : 0;
	  if (color) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Isomer(canvasId, options) {
	  ...
	  this.originY = options.originY || this.canvas.height;
